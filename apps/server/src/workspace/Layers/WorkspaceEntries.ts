...
import { type FilesystemBrowseInput, type ProjectEntry } from "@bide/contracts";
import { isExplicitRelativePath, isWindowsAbsolutePath } from "@bide/shared/path";
import {
  insertRankedSearchResult,
  normalizeSearchQuery,
  scoreQueryMatch,
  type RankedSearchResult,
} from "@bide/shared/searchRanking";
