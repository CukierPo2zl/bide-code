...
import { EDITORS, OpenError, type EditorId } from "@bide/contracts";
import { isCommandAvailable, type CommandAvailabilityOptions } from "@bide/shared/shell";
...
export { OpenError };
export { isCommandAvailable } from "@bide/shared/shell";
