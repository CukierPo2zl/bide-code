          ...
          Layer.mergeAll(
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  BIDECODE_LOG_LEVEL: "Warn",
                  BIDECODE_MODE: "desktop",
                  BIDECODE_PORT: "4001",
                  BIDECODE_HOST: "0.0.0.0",
                  BIDECODE_HOME: baseDir,
                  VITE_DEV_SERVER_URL: "http://127.0.0.1:5173",
                  BIDECODE_NO_BROWSER: "true",
                  BIDECODE_AUTO_BOOTSTRAP_PROJECT_FROM_CWD: "false",
                  BIDECODE_LOG_WS_EVENTS: "true",
                },
              }),
            ),
            NetService.layer,
            ...
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  ...
                  BIDECODE_PORT: "4001",
                  BIDECODE_HOST: "0.0.0.0",
                  BIDECODE_HOME: join(os.tmpdir(), "ignored-base"),
                  VITE_DEV_SERVER_URL: "http://127.0.0.1:5173",
                  BIDECODE_NO_BROWSER: "false",
                  BIDECODE_AUTO_BOOTSTRAP_PROJECT_FROM_CWD: "false",
                  BIDECODE_LOG_WS_EVENTS: "false",
                },
              }),
            ),
            NetService.layer,
        ...
        Effect.provide(
          Layer.mergeAll(
            ConfigProvider.layer(
              ConfigProvider.fromEnv({
                env: {
                  BIDECODE_BOOTSTRAP_FD: String(fd),
                  BIDECODE_NO_BROWSER: "true",
                  BIDECODE_AUTO_BOOTSTRAP_PROJECT_FROM_CWD: "true",
                  BIDECODE_LOG_WS_EVENTS: "true",
                },
              }),
            ),
  ...
  it.effect("applies flag then env precedence over bootstrap envelope values", () =>
    Effect.gen(function* () {
      ...
      const fd = yield* openBootstrapFd({
        ...
        port: 4888,
        host: "127.0.0.2",
        bideHome: "/tmp/t3-bootstrap-home",
        devUrl: "http://127.0.0.1:5173",
        noBrowser: false,
        autoBootstrapProjectFromCwd: false,
        logWebSocketEvents: false,
