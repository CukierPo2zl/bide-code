...
import { makeDrainableWorker } from "@bide/shared/DrainableWorker";
...
const STRICT_PROVIDER_LIFECYCLE_GUARD = process.env.BIDECODE_STRICT_PROVIDER_LIFECYCLE_GUARD !== "0";
