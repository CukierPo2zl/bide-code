import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@bide/contracts";
...
import { KeybindingsConfigError } from "@bide/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "bidecode-keybindings-test-",
        }),
      ),
    ),
  );
