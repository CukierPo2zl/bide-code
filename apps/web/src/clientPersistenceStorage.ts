...
export const CLIENT_SETTINGS_STORAGE_KEY = "bidecode:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "bidecode:saved-environment-registry:v1";
