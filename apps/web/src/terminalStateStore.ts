...
import { parseScopedThreadKey, scopedThreadKey } from "@bide/client-runtime";
import { type ScopedThreadRef, type TerminalEvent } from "@bide/contracts";
...
const TERMINAL_STATE_STORAGE_KEY = "bidecode:terminal-state:v1";
