...
export const PERSISTED_STATE_KEY = "bidecode:ui-state:v1";
const LEGACY_PERSISTED_STATE_KEYS = [
  "bidecode:renderer-state:v8",
  "bidecode:renderer-state:v7",
  "bidecode:renderer-state:v6",
  "bidecode:renderer-state:v5",
  "bidecode:renderer-state:v4",
  "bidecode:renderer-state:v3",
