// This file mostly exists because we want dev mode to say "BIDE code (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "BIDE code (Dev)" : "BIDE code (Alpha)";
const APP_BUNDLE_ID = isDevelopment ? "com.bide.bidecode.dev" : "com.bide.bidecode";
