...
- `/packages/shared`: Shared runtime utilities consumed by both server and web. Uses explicit subpath exports (e.g. `@bide/shared/git`, `@bide/shared/DrainableWorker`) — no barrel index.
